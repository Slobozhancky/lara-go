...
-   Дуже простий спосіб, щоб запити з кореня, йшли в папку public, яка вже і так має свій файл `.htaccess`, щоб прийнти запит
  ![example](https://i.imgur.com/ZL9PM7M.png)
